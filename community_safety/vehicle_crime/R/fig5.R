...
results <- df %>% 
  ...
  add_row(area_code = "E08000009", area_name = "Trafford", category = "Vehicle crime", n = trafford$n, percent = trafford$percent) %>% 
  add_row(area_code = "E47000001", area_name = "Greater Manchester", category = "Vehicle crime", n = gm$n, percent = gm$percent)

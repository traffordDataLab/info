...
results <- df %>% 
  ...
  add_row(area_code = "E08000009", area_name = "Trafford", category = "Violence and sexual offences", n = trafford$n, percent = trafford$percent) %>% 
  add_row(area_code = "E47000001", area_name = "Greater Manchester", category = "Violence and sexual offences", n = gm$n, percent = gm$percent)

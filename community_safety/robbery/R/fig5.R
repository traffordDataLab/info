...
results <- df %>% 
  ...
  add_row(area_name = "Trafford", category = "Robbery", n = trafford$n, percent = trafford$percent) %>% 
  add_row(area_name = "Greater Manchester", category = "Robbery", n = gm$n, percent = gm$percent)

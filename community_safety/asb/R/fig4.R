## Anti-social behaviour: location quotients ##

# load R packages  ---------------------------
library(tidyverse); library(ggplot2); library(sf); library(svglite)
...
ggplot(sf_df) +
  ...
  scale_fill_gradientn(colours = c("#feedde","#fdbe85","#fd8d3c","#e6550d","#a63603"), 
                       ...
                       guide = guide_legend(keyheight = unit(3, units = "mm"), 
                                            ...
                                            title.position = 'top', 
                                            nrow = 1)) +
  labs(x = NULL, y = NULL, title = NULL, fill = 'Anti-social behaviour\nlocation quotient',
